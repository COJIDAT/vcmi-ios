...
#else
std::string IOS_NAME_AFFIX = "server";
std::string IOS_NAME = GameConstants::VCMI_VERSION + std::string(" (") + IOS_NAME_AFFIX + ')'; //application name
#endif
...
void CVCMIServer::loadGame()
{
	...
	for(int i=1; i<clients; i++)
	{
		...
		gh.conns.insert(new CConnection(s.release(),getNAME()));
	}
