...
namespace fl {
    ...
    public:
        ...
        virtual std::string toPrefix(const Expression* node) const;
        virtual std::string toInfix(const Expression* node) const;
        virtual std::string toPostfix(const Expression* node) const;
